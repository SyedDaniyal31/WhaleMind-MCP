/**
 * WhaleMind MCP tools — definitions and execution logic
 */
...
export const TOOL_DEFINITIONS = [
  {
    ...
    description:
      "Deep intelligence report for one Ethereum wallet. Returns risk_level, copy_trade_signal, balance_wei, agent_summary.",
    inputSchema: {
      type: "object",
      properties: {
        address: {
    ...
    outputSchema: {
      type: "object",
      description: "Whale intelligence report",
      properties: {
        address: { type: "string" },
        verdict: { type: "string" },
